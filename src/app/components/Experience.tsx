        ...
        >
          {experiences.map((exp, index) => (
            <motion.div
              ...
              className="group bg-slate-800/50 dark:bg-slate-800/50 light:bg-white/80 backdrop-blur-sm rounded-xl p-8 border border-slate-700/50 dark:border-slate-700/50 light:border-slate-300/50 hover:border-blue-400/50 transition-all duration-300 hover:scale-105"
            >
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-2xl font-semibold text-white dark:text-white light:text-gray-900 mb-1">
                    {exp.title}
                  </h3>
                  <p className="text-lg text-purple-500 dark:text-purple-400 light:text-purple-600 mb-2">{exp.company}</p>
